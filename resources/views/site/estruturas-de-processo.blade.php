...
@extends('template', ['title' => 'Estruturas de Processo'])
...
@section('conteudo-site')
        ...
        <div class="container">
            <nav class="breadcrumbs">
                <ul>
                    ...
                    <li><a>Serviços</a></li>
                    <li><a class="active">Estruturas de Processo</a></li>
                </ul>
            </nav>
        </div>
    </div>
    ...
    <section class="s-content-servicos">
        <div class="container">
            ...
            <div class="bottom">
                <h3>Confira algumas Estruturas de Processo desenvolvidas pela <b style="color:#3EACD2">ConnectBIM</b></h3>
                <div class="galeria">
