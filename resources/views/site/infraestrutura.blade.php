...
@extends('template', ['title' => 'Infraestrutura'])
...
@section('conteudo-site')
        ...
        <div class="container">
            <nav class="breadcrumbs">
                <ul>
                    ...
                    <li><a>Serviços</a></li>
                    <li><a class="active">Infraestrutura</a></li>
                </ul>
            </nav>
        </div>
    </div>
    ...
    <section class="s-content-servicos">
        <div class="container">
            ...
            <div class="bottom">
                <h3>Confira algumas Infraestruturas desenvolvidas pela <b style="color:#3EACD2">ConnectBIM</b></h3>
                <div class="galeria">
